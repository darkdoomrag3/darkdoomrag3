...
- Built a self-healing Playwright framework for an AI/LLM platform with 900+ automated tests and
  400+ BDD scenarios.
- Led migration of 1,200+ regression scenarios from Selenium to Playwright on a platform serving
  20M+ users.
- Reduced regression execution time by 40% with test sharding, parallel execution, CI tuning, and
  trace-based failure diagnostics.
...
<p>
<img src="https://skillicons.dev/icons?i=ts,js,python,cs,react,docker,aws,gcp,git,githubactions,jenkins,linux,bash" alt="TypeScript, JavaScript, Python, C#, React, Docker, AWS, GCP, Git, GitHub Actions, Jenkins, Linux, Bash" />
</p>
...
![OWASP ZAP](https://img.shields.io/badge/-OWASP_ZAP-000000?style=flat-square)
